...
{{Form::model($user, array('url' => URL::to('admin/users/save'),'class' => 'form-horizontal', 'autocomplete'=> 'off'))}}
<div class="row-fluid">
    <div class="span12">
        <div class="box dark">
            <header>
            ...
            <div id="basic" class="accordion-body collapse in body">
                <div class="control-group<?php if($errors->has('username')): echo ' error';endif; ?>">
                    ...
                    <div class="controls">
                        {{Form::text('username', null, array('class'=>'span6', 'readonly'));}}
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {{Form::select('enabled', array('Inactive', 'Active'), $user->enabled)}}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-actions">
            <button class="btn btn-primary" name="action" value="save"><i class="icon-save"></i> Save</button> or
